...
<div className={styles.field}><label>LinkedIn</label>
                <FieldInput icon={<svg className={styles.urlIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="9" width="20" height="13" rx="2"/><path d="M7 9V5a5 5 0 0 1 10 0v4"/></svg>} spellCheck={false} autoComplete="off" autoCorrect="off" autoCapitalize="off" value={data.socials.linkedin} onChange={(e)=>setField(['socials','linkedin'], e.target.value)} placeholder="https://linkedin.com/in/..." />
                </div>
<div className={styles.field}><label>Twitter/X</label>
                <FieldInput icon={<svg className={styles.urlIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.5c1.6 12-14 12-18 6 2 0 4-1 5-2-2-1-3-4-1-6 2 2 4 3 7 3-1-5 6-7 9-3z"/></svg>} spellCheck={false} autoComplete="off" autoCorrect="off" autoCapitalize="off" value={data.socials.twitter} onChange={(e)=>setField(['socials','twitter'], e.target.value)} placeholder="https://x.com/..." />
                </div>
<div className={styles.field}><label>Instagram</label>
                <FieldInput icon={<svg className={styles.urlIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.5" y2="6.5"/></svg>} spellCheck={false} autoComplete="off" autoCorrect="off" autoCapitalize="off" value={data.socials.instagram} onChange={(e)=>setField(['socials','instagram'], e.target.value)} placeholder="https://instagram.com/..." />
                </div>
              </div>
            </div>
            ...
            <div className={styles.formCard}>
              ...
              {(data.projects||[]).map((p, idx) => (
                <div key={idx} className={styles.groupCard}>
                  ...
                  <div className={styles.grid2}>
<div className={styles.field}><label>Título</label>
<FieldInput icon={<Icon.text className={styles.inputIcon} />} spellCheck={false} autoComplete="off" autoCorrect="off" autoCapitalize="sentences" value={p.title||''} onChange={(e)=>updateArrayItem('projects', idx, { title: e.target.value })} />
                    </div>
